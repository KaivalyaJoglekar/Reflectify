...
class _AppBackgroundState extends State<AppBackground>
  ...
  void initState() {
    ...
    // Set up a long, slow, repeating animation - increased duration for better performance
    _controller = AnimationController(
      duration: const Duration(
        seconds: 40,
      ), // Much slower animation for less CPU usage
      vsync: this,
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
          ...
          // Subtle radial overlays to create mesh/aurora feel - wrapped in RepaintBoundary
          Positioned.fill(
                          ...
                          child: Container(
                            ...
                            decoration: const BoxDecoration(
                              gradient: RadialGradient(
                                ...
                                colors: [
                                  Color.fromRGBO(224, 64, 251, 0.75),
